<?php /* Smarty version Smarty-3.1.14, created on 2023-05-07 13:59:39
         compiled from "C:\xampp\htdocs\wa\wa-system\design\templates-legacy\DesignEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:2061523875645792abbb6870-35336667%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33f6d2ab43cf032fad1301f70755a9347bcd7f08' => 
    array (
      0 => 'C:\\xampp\\htdocs\\wa\\wa-system\\design\\templates-legacy\\DesignEdit.html',
      1 => 1617787741,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2061523875645792abbb6870-35336667',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_645792abca9796_80697125',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_645792abca9796_80697125')) {function content_645792abca9796_80697125($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\xampp\\htdocs\\wa\\wa-system\\vendors\\smarty3\\plugins\\modifier.truncate.php';
...
" title="<?php if (!empty($_smarty_tpl->tpl_vars['f']->value['parent_exists'])){?>файл родительской темы: <?php }?><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['f_id']->value, ENT_QUOTES, 'UTF-8', true);?>
">
                    <i class="icon16 <?php if (!empty($_smarty_tpl->tpl_vars['f']->value['parent_exists'])){?>link<?php }else{ ?>script<?php if (substr($_smarty_tpl->tpl_vars['f_id']->value,-4)=='.css'){?>-css<?php }elseif(substr($_smarty_tpl->tpl_vars['f_id']->value,-3)=='.js'){?>-js<?php }?><?php }?>"></i><?php echo smarty_modifier_truncate(htmlspecialchars((string)$_smarty_tpl->tpl_vars['f_id']->value, ENT_QUOTES, 'UTF-8', true),25,'...',false,true);?>
                                        ...
                                        onSubmit: function (dialog) {
                                            if (confirm('Это сбросит все выполненные вами изменения. Вы уверены?')) {
                                                $.post('?module=design&action=revertFile', {
                                                    theme: '<?php echo $_smarty_tpl->tpl_vars['theme']->value['id'];?>
',
                                                    file: '<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
'
                                                }, function (response) {
...
&file=";
            ...
            <?php }?>
            <h4>
                <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['id'], ENT_QUOTES, 'UTF-8', true);?>

                <?php if (isset($_smarty_tpl->tpl_vars['file']->value['description'])){?><span id="wa-design-desc" class="hint"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
</span><?php }?>
            </h4>
                ...
                <div class="fields form">
                    <div id="wa-file-create-group" class="field-group">
                        <div class="field">
                            ...
                            <div class="value">
                                <input name="file" type="text" class="bold" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
" />
                        ...
                        <div class="field">
                            ...
                            <div class="value">
                                <textarea id="s-text-desc" name="description"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
...
"><?php echo $_smarty_tpl->tpl_vars['f_id']->value;?>
        ...
        <div class="wa-editor-core-wrapper ace">
            <div style="clear:both">
                <textarea style="display:none" id="wa-design-content" name="content"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['content'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
            </div>
        </div>
    ...
    $(document).ready(function () {
        ...
        <?php if ($_smarty_tpl->tpl_vars['options']->value['is_ajax']){?>
            <?php if ($_smarty_tpl->tpl_vars['file']->value&&$_smarty_tpl->tpl_vars['file']->value['id']){?>
                document.title = "<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['file']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
