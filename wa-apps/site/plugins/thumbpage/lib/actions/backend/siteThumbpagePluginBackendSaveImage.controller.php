...
class siteThumbpagePluginBackendSaveImageController extends waJsonController
{
    ...
    public function execute()
    {
        ...
        if ($file->uploaded()) {
            ...
            try {
                ...
                $this->response['preview'] = wa()->getDataUrl('plugins/thumbpage/images/' . $name, true, 'site');
